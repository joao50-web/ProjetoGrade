...
export default function GradeTabela() {
    ...
    const columns = [
        {
            ...
            render: text => (
                <span style={{ color: '#000000', fontWeight: 500 }}>{text}</span>
            ),
        },
        ...dias.map(d => ({
            title: d.descricao,
                ...
                return (
                    <Select
                        ...
                        options={disciplinas.map(opt => ({
                            ...
                            disciplina: opt.disciplina_nome, // 👈 usado no select selecionado
                            label: (
                                <div>
    ...
    return (
        <div style={{ background: '#c3d6e9', padding: 8 }}>
            {/* BOTÕES TOPO DIREITO */}
            ...
            {/* TÍTULO */}
            <Title level={4} style={{ margin: '16px 0 32px' }}>
                Grade Horária
            </Title>
